...
#ifndef INCLUDED_AIS_CORR_EST_CC_H
#define INCLUDED_AIS_CORR_EST_CC_H
...
namespace gr
{
  namespace ais
  {
     ...
     *
     */
    class AIS_API corr_est_cc : virtual public gr::sync_block
    {
    public:
...
#endif /* INCLUDED_AIS_CORR_EST_CC_H */
